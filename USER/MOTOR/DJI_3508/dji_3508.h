 ...
 * @license: MIT
 ******************************************************************************/
#ifndef MC02_GENERAL_FRAMEWORK_LITE_DJI_3508_H
#define MC02_GENERAL_FRAMEWORK_LITE_DJI_3508_H
#include "main.h"
...
typedef enum
{
    CAN_3508_CHASSIS_ALL_ID = 0x200,  // 所有底盘电机的CAN ID
    CAN_3508_SHOOT_ALL_ID = 0x200,	  // 所有发射机构电机的CAN ID
...
/**
  ...
  * @retval         none
  */
void DJI_3508_CtrlMotor(CAN_HandleTypeDef* hcan, CAN_TxHeaderTypeDef motor_tx_message, uint8_t motor_can_send_data[8], uint16_t id, int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
...
#endif //MC02_GENERAL_FRAMEWORK_LITE_DJI_3508_H
