...
//#define PITCH_SPEED_PID_MAX_IOUT  12000.0f
#define PITCH_SPEED_PID_KP        2000.0f
#define PITCH_SPEED_PID_KI        0.5f
#define PITCH_SPEED_PID_KD        0.0f
#define PITCH_SPEED_PID_MAX_OUT   10000.0f
#define PITCH_SPEED_PID_MAX_IOUT  30.0f


//yaw speed close-loop PID params, max out and max iout
//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_SPEED_PID_KP        3000.0f  //3600.0f 3000
#define YAW_SPEED_PID_KI        20.f//20.0f
#define YAW_SPEED_PID_KD        0.0f
#define YAW_SPEED_PID_MAX_OUT   30000.0f //30000.0f
#define YAW_SPEED_PID_MAX_IOUT  5000.f//5000.0f
...
#define PITCH_GYRO_ABSOLUTE_PID_KP 75.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 1.5f
#define PITCH_GYRO_ABSOLUTE_PID_KD 0.7f

#define PITCH_GYRO_ABSOLUTE_PID_MAX_OUT 300.0f
#define PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT 3000.0f

//yaw gyro angle close-loop PID params, max out and max iout
//yaw 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define YAW_GYRO_ABSOLUTE_PID_KP        115.0f
...
#define PITCH_ENCODE_RELATIVE_PID_KP 60.0f   //  15
#define PITCH_ENCODE_RELATIVE_PID_KI 1.5f
#define PITCH_ENCODE_RELATIVE_PID_KD 0.5f

#define PITCH_ENCODE_RELATIVE_PID_MAX_OUT  300.0f
#define PITCH_ENCODE_RELATIVE_PID_MAX_IOUT 300.0f
...
//pitch绝对角度控制限幅 （rad/s）
#define PITCH_ABSOLUTE_ANGLE_MIN   -0.15
#define PITCH_ABSOLUTE_ANGLE_MAX   0.5
#define YAW_ABSOLUTE_ANGLE_MIN   -1.2
#define YAW_ABSOLUTE_ANGLE_MAX   0.79
...
#define PITCH_RC_SEN  -0.000006f //-0.000006f
...
#define RECORD_CENTER_KEY KEY_PRESSED_OFFSET_X //标定圆心
#define RECORD_RADIUS_KEY KEY_PRESSED_OFFSET_C //标定半径处

#define AT_CHANGE_KEY KEY_PRESSED_OFFSET_CTRL //打符与自瞄切换


//测试代码
//定义测试模式
#define Test_Mode  0     // 0为完整模式，1为shoot测试模式，2为Pitch测试模式，3为Yaw测试模式
